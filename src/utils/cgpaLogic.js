...
// Open Minor Categories
export const openMinors = {
    "Android Application Development": [
        "CSE224", "CSE225", "CSE226", "CSE227", "INT397"
    ],
    "Banking and Financial Services": [
        "FIN314", "FIN318", "FIN319", "FIN901"
    ],
    "Business Laws": [
        "LAW252", "LAW255", "LAW256", "LAW257"
    ]
};
...
export const curriculum = {
    ...
    "6": {
        ...
        "OPEN_MINOR_2_BASKET": {
            "Various_Open_Minor_Courses": { "note": "see Term5 open minor basket for full list" }
        }
    },
    "7": {
        "COURSEWORK_VARIANT": {
    ...
    "8": {
        ...
        "OPEN_MINOR_4_BASKET": {
            ...
            "LAW256": { "credit": 3 },
            "LAW257": { "credit": 3 },
            "and_more": { "note": "Open Minor basket is large; see Term5 open minor basket for full list" }
        }
    }
};
